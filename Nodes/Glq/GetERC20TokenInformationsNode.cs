...
namespace NodeBlock.Plugin.GlqChain.Nodes.Glq
{
    [NodeDefinition("GetERC20TokenInformationsNode", "Get ERC20 Informations", NodeTypeEnum.Function, "Blockchain.GraphLinq.ERC20")]
    ...
    public class GetERC20TokenInformationsNode : Node
    {
        ...
        public override bool OnExecution()
        {
            ...
            var contractHandler = glqConnection.Web3Client.Eth.GetContractHandler(this.InParameters["tokenContract"].GetValue().ToString());
